...
struct ANGELSCRIPTCODE_API FAngelscriptActorBinds
{
	...
	static UActorComponent* GetComponent(const AActor* Actor, const TSubclassOf<UActorComponent>& ComponentClass, const FName& WithName);
	...
	static void GetAllComponents(const AActor* Actor, UClass* ComponentClass, TArray<UActorComponent*>& OutComponents);

	static UActorComponent* GetComponentFromMeta(class asCScriptFunction* Meta, const AActor* Actor, const FName& WithName);
	...
	static void GetComponentGeneric(const AActor* Actor, const TSubclassOf<UObject>& ComponentClass, void* OutComponent, int TypeId, const FName& WithName)
	{
	...
	static void GetAllComponentsGeneric(const AActor* Actor, const TSubclassOf<UObject>& ComponentClass, void* OutComponentsArray, int TypeId, const FName& WithName)
	{
