...
public:
	...
	/**
	 * The original Angelscript integration code has a focus on testing multiplayer, using a
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category = IntegrationTests)
	bool bUseServerClientModel = true;
	...
	*/
	...
	UPROPERTY(EditAnywhere, config, Category = UnitTests)
	const TSoftClassPtr<class UGameInstance> UnitTestGameInstanceClass;
