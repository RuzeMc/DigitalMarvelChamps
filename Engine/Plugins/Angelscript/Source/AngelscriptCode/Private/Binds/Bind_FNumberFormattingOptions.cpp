...
AS_FORCE_LINK const FAngelscriptBinds::FBind Bind_FNumberFormattingOptions(FAngelscriptBinds::EOrder::Early, []
	{
		...
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetAlwaysSign(bool InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetAlwaysSign));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetUseGrouping(bool InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetUseGrouping));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetRoundingMode(ERoundingMode InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetRoundingMode));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetMinimumIntegralDigits(int32 InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetMinimumIntegralDigits));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetMaximumIntegralDigits(int32 InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetMaximumIntegralDigits));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetMinimumFractionalDigits(int32 InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetMinimumFractionalDigits));
		FNumberFormattingOptions_.Method("FNumberFormattingOptions& SetMaximumFractionalDigits(int32 InValue) accept_temporary_this", METHOD_TRIVIAL(FNumberFormattingOptions, SetMaximumFractionalDigits));
