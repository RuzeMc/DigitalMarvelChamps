...
AS_FORCE_LINK const FAngelscriptBinds::FBind Bind_FRandomStream(FAngelscriptBinds::EOrder::Early, []
{
	...
	FRandomStream_.SetTypeUserData(TBaseStructure<FRandomStream>::Get());
	...
	FRandomStream_.Method("FRandomStream& opAssign(const FRandomStream& Other)", METHODPR_TRIVIAL(FRandomStream&, FRandomStream, operator=, (const FRandomStream&)));
