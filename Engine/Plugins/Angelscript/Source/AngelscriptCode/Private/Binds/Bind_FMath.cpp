...
AS_FORCE_LINK const FAngelscriptBinds::FBind Bind_FMath([]
{
	...
	SCRIPT_BIND_DOCUMENTATION("Clamps X to be between Min and Max, inclusive");
	FAngelscriptBinds::BindGlobalFunction("int64 Clamp(int64 X, int64 Min, int64 Max) no_discard", FUNC_TRIVIAL(FMath::Clamp<int64>));
	SCRIPT_BIND_DOCUMENTATION("Clamps X to be between Min and Max, inclusive");
	FAngelscriptBinds::BindGlobalFunction("uint64 Clamp(uint64 X, uint64 Min, uint64 Max) no_discard", FUNC_TRIVIAL(FMath::Clamp<uint64>));
	SCRIPT_BIND_DOCUMENTATION("Clamps X to be between Min and Max, inclusive");
	...
	FAngelscriptBinds::BindGlobalFunction("float64 CubicInterp(const float64& Point0, const float64& Tangent0, const float64& Point1, const float64& Tangent1, const float64& Alpha) no_discard", &FMath::CubicInterp<double, double>, "FMath::CubicInterp<double, double>", true);
	...
	FAngelscriptBinds::BindGlobalFunction("bool LinePlaneIntersection(const FVector& LineStart, const FVector& LineEnd, const FPlane& Plane, float32& T, FVector& Intersection)",
		[](const FVector& LineStart, const FVector& LineEnd, const FPlane& Plane, float& T, FVector& Intersection) -> bool
		{
			return UKismetMathLibrary::LinePlaneIntersection(LineStart, LineEnd, Plane, T, Intersection);
		});
	SCRIPT_BIND_DOCUMENTATION(
		"Computes the intersection point between a line and a plane.\n"
		"@param T - The time of the intersection between the line and the plane.\n"
	...
	FAngelscriptBinds::BindGlobalFunction("int64 Abs(int64 Value) no_discard", FUNC_TRIVIAL(FMath::Abs<int64>));
	...
	FAngelscriptBinds::BindGlobalFunction("int64 Sign(int64 Value) no_discard", FUNC_TRIVIAL(FMath::Sign<int64>));
	...
	FAngelscriptBinds::BindGlobalFunction("int64 Min(int64 A, int64 B) no_discard", FUNCPR_TRIVIAL(int64, FMath::Min<int64>, (const int64, const int64)));
	FAngelscriptBinds::BindGlobalFunction("uint64 Min(uint64 A, uint64 B) no_discard", FUNCPR_TRIVIAL(uint64, FMath::Min<uint64>, (const uint64, const uint64)));
	...
	FAngelscriptBinds::BindGlobalFunction("int64 Max(int64 A, int64 B) no_discard", FUNCPR_TRIVIAL(int64, FMath::Max<int64>, (const int64, const int64)));
	FAngelscriptBinds::BindGlobalFunction("uint64 Max(uint64 A, uint64 B) no_discard", FUNCPR_TRIVIAL(uint64, FMath::Max<uint64>, (const uint64, const uint64)));
	...
	FAngelscriptBinds::BindGlobalFunction("int64 Square(int64 Value) no_discard", FUNC_TRIVIAL(FMath::Square<int64>));
	FAngelscriptBinds::BindGlobalFunction("uint64 Square(uint64 Value) no_discard", FUNC_TRIVIAL(FMath::Square<uint64>));
