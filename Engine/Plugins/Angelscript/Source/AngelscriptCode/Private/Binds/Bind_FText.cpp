...
struct FTextType : TAngelscriptCppPropertyType<FTextProperty>
{
	...
	bool CanCompareForHotReload(const FAngelscriptTypeUsage& Usage) const override
	{
		return true;
	}
...
{
	auto ETextComparisonLevel_ = FAngelscriptBinds::Enum("ETextComparisonLevel");
	ETextComparisonLevel_["Default"] = ETextComparisonLevel::Type::Default;
	ETextComparisonLevel_["Primary"] = ETextComparisonLevel::Type::Primary;
	ETextComparisonLevel_["Secondary"] = ETextComparisonLevel::Type::Secondary;
	ETextComparisonLevel_["Tertiary"] = ETextComparisonLevel::Type::Tertiary;
	ETextComparisonLevel_["Quaternary"] = ETextComparisonLevel::Type::Quaternary;
	ETextComparisonLevel_["Quinary"] = ETextComparisonLevel::Type::Quinary;
	...
	FText_.Method("int32 CompareTo(const FText& Other, const ETextComparisonLevel ComparisonLevel = ETextComparisonLevel::Default) const", METHOD_TRIVIAL(FText, CompareTo));
	FText_.Method("int32 CompareToCaseIgnored(const FText& Other) const", METHOD_TRIVIAL(FText, CompareToCaseIgnored));
	FText_.Method("bool EqualTo(const FText& Other, const ETextComparisonLevel ComparisonLevel = ETextComparisonLevel::Default) const", METHOD_TRIVIAL(FText, EqualTo));
	FText_.Method("bool EqualToCaseIgnored(const FText& Other) const", METHOD_TRIVIAL(FText, EqualToCaseIgnored));
	FText_.Method("FText ToLower() const", METHOD_TRIVIAL(FText, ToLower));
	FText_.Method("FText ToUpper() const", METHOD_TRIVIAL(FText, ToUpper));
...
AS_FORCE_LINK const FAngelscriptBinds::FBind Bind_FText_Operations(FAngelscriptBinds::EOrder::Late, []
{
...

	{
		...
		FAngelscriptBinds::BindGlobalFunction("FText AsDate(const FDateTime& DateTime, const EDateTimeStyle DateStyle = EDateTimeStyle::Default) no_discard",
			[](const FDateTime& DateTime, const EDateTimeStyle::Type DateStyle) -> FText { return FText::AsDate(DateTime, DateStyle); });
		FAngelscriptBinds::BindGlobalFunction("FText AsDateTime(const FDateTime& DateTime, const EDateTimeStyle DateStyle = EDateTimeStyle::Default, const EDateTimeStyle TimeStyle = EDateTimeStyle::Default) no_discard",
		...
		FAngelscriptBinds::BindGlobalFunction("FText AsTime(const FDateTime& DateTime, const EDateTimeStyle TimeStyle = EDateTimeStyle::Default) no_discard",
