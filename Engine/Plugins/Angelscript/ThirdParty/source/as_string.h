...
class ANGELSCRIPTCODE_API asCString
{
public:
	asCString();
	~asCString();
...
ANGELSCRIPTCODE_API bool operator ==(const asCString &, const asCString &);
ANGELSCRIPTCODE_API bool operator !=(const asCString &, const asCString &);

ANGELSCRIPTCODE_API bool operator ==(const asCString &, const char *);
ANGELSCRIPTCODE_API bool operator !=(const asCString &, const char *);

ANGELSCRIPTCODE_API bool operator ==(const char *, const asCString &);
ANGELSCRIPTCODE_API bool operator !=(const char *, const asCString &);

ANGELSCRIPTCODE_API bool operator <(const asCString &, const asCString &);

ANGELSCRIPTCODE_API asCString operator +(const asCString &, const char *);
ANGELSCRIPTCODE_API asCString operator +(const char *, const asCString &);
ANGELSCRIPTCODE_API asCString operator +(const asCString &, const asCString &);
