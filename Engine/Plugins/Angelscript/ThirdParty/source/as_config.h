...
// MSVC2015 can now use CLang too, but it shouldn't go in here
	...
	// PS4
		...
		#define AS_ONLY_NONTRIVIAL_COPY_PASS_AS_REF
	...
	// WII U
		...
		#define SPLIT_OBJS_BY_MEMBER_TYPES
		#define AS_LARGE_OBJS_PASSED_BY_REF
		#define AS_LARGE_OBJ_MIN_SIZE 8
	...
	// Dreamcast
	#elif defined(__SH4_SINGLE_ONLY__) && __SH4_SINGLE_ONLY__
...
#ifndef ANGELSCRIPTCODE_API
#define ANGELSCRIPTCODE_API 
#endif
