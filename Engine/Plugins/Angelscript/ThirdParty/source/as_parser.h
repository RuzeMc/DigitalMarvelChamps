...
public:
	...
	int ParsePropertyDeclaration(asCScriptCode *script, bool isAppInterface);
	int ParseDataType(asCScriptCode *script, bool isReturnType, bool isAppInterface);
	...
	int ParseStatement(asCScriptCode *script, asCScriptNode *block);
...
protected:
	...
	void ResolveFloatTypeWidth(asCScriptNode* node, sToken* token);
	...
	asCScriptNode *SuperficiallyParseStatement();
	...
	asCScriptNode *ParseExpressionStatementCondition();
	...
	asCScriptNode *ParseFallthrough();
	...
	bool IsAccessDecl();
	asCScriptNode *ParseAccessDecl();

	bool IsClassDefaultStatement();
	asCScriptNode *ParseClassDefaultStatement();

	// Expressions
	asCScriptNode *ParseAssignment();
	asCScriptNode *ParseAssignOperator();
	asCScriptNode *ParseCondition();
	asCScriptNode *ParseConditionAsAssignment();
