...
ANGELSCRIPT_INCLUDE := $(SDK_BASE_PATH)/ThirdParty/include/
...
LOCAL_SRC_FILES := $(wildcard $(SDK_BASE_PATH)/ThirdParty/source/*.S)
LOCAL_SRC_FILES += $(wildcard $(SDK_BASE_PATH)/ThirdParty/source/*.cpp)
LOCAL_PATH := .
LOCAL_ARM_MODE := arm
