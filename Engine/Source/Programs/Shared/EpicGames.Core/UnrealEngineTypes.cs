...
// HAZE FIX(LV): Expose type-erased method pointers to native C++ methods
		ImplementationConstRef			= 0x0000002000000000,
		ImplementationNonConstRef		= 0x0000000004000000,
		ImplementationEnumAsByte		= 0x4000000000000000,
		ImplementationFScriptInterface	= 0x8000000000000000,
		RuntimeGenerated				= 0x0000000000100000,
		WorldContext					= 0x0000000000400000,
		ConstTemplateArg				= 0x0000000000800000,

		NeverDisallow = ImplementationConstRef | ImplementationNonConstRef | ImplementationEnumAsByte | ImplementationFScriptInterface | ConstTemplateArg,
		AlwaysPropagate = ImplementationEnumAsByte | ImplementationFScriptInterface,
		...
		/// </summary>
		PropagateToArrayInner =	ExportObject | PersistentInstance | InstancedReference | ContainsInstancedReference | Config | EditConst | Deprecated | EditorOnly | AutoWeak | UObjectWrapper | TObjectPtr | AlwaysPropagate,

		/// <summary>
		/// Flags that are propagated to properties inside optional container
		/// </summary>
		PropagateToOptionalInner = ExportObject | PersistentInstance | InstancedReference | ContainsInstancedReference | Config | EditConst | Deprecated | EditorOnly | AutoWeak | UObjectWrapper | Edit | AlwaysPropagate,

		/// <summary>
		/// Flags that are propagated to value properties inside map container
		/// </summary>
		PropagateToMapValue = ExportObject | PersistentInstance | InstancedReference | ContainsInstancedReference | Config | EditConst | Deprecated | EditorOnly | AutoWeak | UObjectWrapper | TObjectPtr | Edit | AlwaysPropagate,

		/// <summary>
		/// Flags that are propagated to key properties inside map container
		/// </summary>
		PropagateToMapKey = ExportObject | PersistentInstance | InstancedReference | ContainsInstancedReference | Config | EditConst | Deprecated | EditorOnly | AutoWeak | UObjectWrapper | TObjectPtr | Edit | AlwaysPropagate,

		/// <summary>
		/// Flags that are propagated to properties inside set container
		/// </summary>
		PropagateToSetElement = ExportObject | PersistentInstance | InstancedReference | ContainsInstancedReference | Config | EditConst | Deprecated | EditorOnly | AutoWeak | UObjectWrapper | TObjectPtr | Edit | AlwaysPropagate,
// END HAZE FIX
