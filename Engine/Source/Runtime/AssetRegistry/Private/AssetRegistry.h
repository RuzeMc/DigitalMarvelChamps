...
// AS FIX (Lucas de Vries <lucas@hazelight.se>): Regenerate asset management database before chunking
public:
	void Hack_AddManualAssetDependency(FName ReferencerPackage, FName DependencyPackage);
// END AS FIX
