...
// HAZE FIX(LV): Expose type-erased method pointers to native C++ methods
	CPF_ImplementationConstRef			= 0x0000002000000000,
	CPF_ImplementationNonConstRef		= 0x0000000004000000,
	CPF_ImplementationEnumAsByte		= 0x4000000000000000,
	CPF_ImplementationFScriptInterface	= 0x8000000000000000,
	CPF_RuntimeGenerated				= 0x0000000000100000,
	CPF_WorldContext					= 0x0000000000400000,
	CPF_ConstTemplateArg				= 0x0000000000800000,
// END HAZE FIX
};
...
//@{
// HAZE FIX(LV): Expose type-erased method pointers to native C++ methods
#define CPF_NeverDisallow			(CPF_ImplementationConstRef | CPF_ImplementationNonConstRef | CPF_ImplementationEnumAsByte | CPF_ImplementationFScriptInterface | CPF_ConstTemplateArg)
#define CPF_SignatureIgnored         CPF_RuntimeGenerated | CPF_NeverDisallow
#define CPF_AlwaysPropagate			(CPF_ImplementationEnumAsByte | CPF_ImplementationFScriptInterface)
// END HAZE FIX
...
#define CPF_PropagateToArrayInner    (CPF_ExportObject | CPF_PersistentInstance | CPF_InstancedReference | CPF_ContainsInstancedReference | CPF_Config | CPF_EditConst | CPF_Deprecated | CPF_EditorOnly | CPF_AutoWeak | CPF_UObjectWrapper | CPF_AlwaysPropagate )
#define CPF_PropagateToOptionalInner (CPF_ExportObject | CPF_PersistentInstance | CPF_InstancedReference | CPF_ContainsInstancedReference | CPF_Config | CPF_EditConst | CPF_Deprecated | CPF_EditorOnly | CPF_AutoWeak | CPF_UObjectWrapper | CPF_Edit | CPF_AlwaysPropagate )
#define CPF_PropagateToMapValue      (CPF_ExportObject | CPF_PersistentInstance | CPF_InstancedReference | CPF_ContainsInstancedReference | CPF_Config | CPF_EditConst | CPF_Deprecated | CPF_EditorOnly | CPF_AutoWeak | CPF_UObjectWrapper | CPF_Edit | CPF_AlwaysPropagate )
#define CPF_PropagateToMapKey        (CPF_ExportObject | CPF_PersistentInstance | CPF_InstancedReference | CPF_ContainsInstancedReference | CPF_Config | CPF_EditConst | CPF_Deprecated | CPF_EditorOnly | CPF_AutoWeak | CPF_UObjectWrapper | CPF_Edit | CPF_AlwaysPropagate )
#define CPF_PropagateToSetElement    (CPF_ExportObject | CPF_PersistentInstance | CPF_InstancedReference | CPF_ContainsInstancedReference | CPF_Config | CPF_EditConst | CPF_Deprecated | CPF_EditorOnly | CPF_AutoWeak | CPF_UObjectWrapper | CPF_Edit | CPF_AlwaysPropagate )
// END HAZE FIX
