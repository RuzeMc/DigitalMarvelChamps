...
// HAZE FIX(LV): Consider angelscript classes as classes for redirects
	static const FName NAME_ASClass("ASClass");
	if (TypeName == NAME_ASClass)
	{
		return ECoreRedirectFlags::Type_Class;
	}

	static const FName NAME_ASStruct("ASStruct");
	if (TypeName == NAME_ASStruct)
	{
		return ECoreRedirectFlags::Type_Struct;
	}

	static const FName NAME_ASFunction("ASFunction");
	if (TypeName == NAME_ASFunction)
	{
		return ECoreRedirectFlags::Type_Function;
	}
// END HAZE FIX
