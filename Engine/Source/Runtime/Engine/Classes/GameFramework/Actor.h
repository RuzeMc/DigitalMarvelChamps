...
public:
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, meta=(BlueprintInternalUseOnly = "true", DisplayName = "Construction Script", ScriptName = "ConstructionScript"))
...
// HAZE FIX(LV): Fix attachments not updating on reloads
	ENGINE_API void ResetInheritedComponentAttachment();
// END HAZE FIX
