...
class UKismetSystemLibrary : public UBlueprintFunctionLibrary
{
	...
	static ENGINE_API FTimerHandle K2_SetTimer(UObject* Object, FName FunctionName, float Time, bool bLooping, bool bMaxOncePerFrame = false, float InitialStartDelay = 0.f, float InitialStartDelayVariance = 0.f);
