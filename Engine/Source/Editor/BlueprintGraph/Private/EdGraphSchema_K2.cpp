...
// HAZE FIX(LV): Runtime generated classes (angelscript)
	if (((UScriptStruct*)InStruct)->GetNewestVersion() != InStruct)
		return false;
// END HAZE FIX
...
// AS FIX(LV): Always use the latest version of the type
		OutSubCategoryObject = StructProperty->Struct->GetNewestVersion();
// END HAZE FIX
