...
// AS FIX (AH): Propagate ScriptStruct changes to editor tools
	class FScriptStructEditorManager : public FListenerManager<UScriptStruct, EStructureEditorChangeInfo>
	{
	public:
		UNREALED_API static FScriptStructEditorManager& Get();

		class UNREALED_API ListenerType : public InnerListenerType<FScriptStructEditorManager>
		{
		};
	...
	typedef FScriptStructEditorManager::ListenerType INotifyOnScriptStructChanged;
// END AS FIX
...
// AS FIX (AH): Propagate ScriptStruct changes to editor tools
	static UNREALED_API void BroadcastPreChange(UScriptStruct* Struct);
	static UNREALED_API void BroadcastPostChange(UScriptStruct* Struct);
// END AS FIX
};
