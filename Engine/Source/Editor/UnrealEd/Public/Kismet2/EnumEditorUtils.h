...
{
public: // HAHAHA HAZE FIX (LV)
	static UNREALED_API void PrepareForChange(UUserDefinedEnum* Enum);
	static UNREALED_API void BroadcastChanges(const UUserDefinedEnum* Enum, const TArray<TPair<FName, int64>>& OldNames, bool bResolveData = true);
