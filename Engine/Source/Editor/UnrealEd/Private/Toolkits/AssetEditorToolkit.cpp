...
// HAZE FIX(LV): Need an event for when assets are saved
UNREALED_API TFunction<void(UObject*)> GAssetEditorToolkit_PreSaveObject;
// END HAZE FIX
...
// HAZE FIX(LV): Need an event for when assets are saved
		if (GAssetEditorToolkit_PreSaveObject)
			GAssetEditorToolkit_PreSaveObject(Object);
// END HAZE FIX
	}
