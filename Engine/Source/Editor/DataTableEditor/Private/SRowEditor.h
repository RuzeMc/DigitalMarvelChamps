...
// AS FIX (AH): Propagate ScriptStruct changes to editor tools
	, public FStructureEditorUtils::INotifyOnScriptStructChanged
// END AS FIX
...
// AS FIX (AH): Propagate ScriptStruct changes to editor tools
	// INotifyOnScriptStructChanged
	virtual void PreChange(const class UScriptStruct* Struct, FStructureEditorUtils::EStructureEditorChangeInfo Info) override;
	virtual void PostChange(const class UScriptStruct* Struct, FStructureEditorUtils::EStructureEditorChangeInfo Info) override;
// END AS FIX
